...
class speechTaiwanese{
  final String label = "A";
  final serviceId = "0001";
  //由SERVER端提供之token
  final String token =
      "eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MDUyMjMxMjIsImlhdCI6MTY0MjE1MTEyMiwic3ViIjoiIiwiYXVkIjoid21ta3MuY3NpZS5lZHUudHciLCJpc3MiOiJKV1QiLCJ1c2VyX2lkIjoiMjk4IiwibmJmIjoxNjQyMTUxMTIyLCJ2ZXIiOjAuMSwic2VydmljZV9pZCI6IjEwIiwiaWQiOjQyNiwic2NvcGVzIjoiMCJ9.PcZ5CMaV6rV77Yguz-Ch-Rwk3SjlL07BtdORqkcy5S3hrpB_M-p9AB9WtFywQQICXPRaOiKcNLgAa42Q8GhdlbrHqY58iGwImvjn1bmeK05frzZjZXMonK-n7UKjhTAKbj51gJD6je5P2OTuhrIegaX2MNREhTcVkYtczn262Bw";
  ...
  Future connect(
    ...
    //連接socket
    await Socket.connect("140.116.245.149", 27002).then((socket) {
